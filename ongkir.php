                      ...
                      <div class="panel-body">
                          ...
                          <form class="form-horizontal" id="ongkir" method="POST" action="cek_ongkir.php">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-9">
                                      <input type="text" class="form-control" id="harga_barang" name="harga_barang" required="" value="<?= $data['harga']; ?>" readonly>
                                  </div>
                              </div>
                              <div class="form-group">
                                  <br>
              ...
              <div class="col-md-7" id="response_ongkir">
                  ...
                  <?php
                    if (isset($_SESSION['ongkir'])) {
                        echo "<h3>Ongkos Kirim: " . $_SESSION['ongkir'] . "</h3>";
                        echo "<h3>Total Harga: " . ($data['harga'] + $_SESSION['ongkir']) . "</h3>";
